...
class LangChainAIProvider(IBaseAIProvider):
    def __init__(self, vectordb_connection_string: str, db_name: str, collection_name: str, index_name: str,req:TrainLangchainDocumentRequest):
    ...
    def save_vector(self, chunks: List[Document], document_path: str) -> bool:
        ...
        vectorstore.create_index(
            self.num_list, self.dimensions, CosmosDBSimilarityType.COS
        )
